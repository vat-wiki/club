...
// the focused channel. Rename/delete live in the Settings overlay now; this list
// is pure navigation.
function ChannelRow({
  channel,
  active,
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "flex w-full items-center gap-2 rounded-md px-4 font-mono text-sm transition-colors duration-fast",
        mobile ? "min-h-[44px] py-1.5" : "min-h-[36px] py-1.5",
        active
