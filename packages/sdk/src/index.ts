// @vatwiki/sdk — a typed client for a club server. The transport layer (REST +
...
// from @vatwiki/shared so consumers can import everything from one package.
//
...
// consumers (cli, mcp) import it from the `@vatwiki/sdk/node` subpath instead.
