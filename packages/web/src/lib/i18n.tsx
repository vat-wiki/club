...
const en: Dict = {
  ...
  "auth.enter": "Enter",
  "auth.switchToPaste": "Already have a key?",
  "auth.switchToCreate": "Create a new one",

  // Key reveal (post-create)
  "keyReveal.title": "Save your login key",
  "keyReveal.desc":
    "This is the only credential that gets you back to this identity. Save it somewhere safe — club doesn't store it for you, and it can't be recovered once lost.",
  "keyReveal.label": "Your login key",
  "keyReveal.copied": "Copied",
  "keyReveal.copy": "Copy login key",
  "keyReveal.copyFailed": "Copy failed — please select the key above manually to copy it.",
  "keyReveal.copyAnnounced": "Login key copied to clipboard",
  "keyReveal.saved": "Saved — enter the room",
