...
import { Check,Copy, Hash, LogOut, RefreshCw, Trash2, UserMinus } from "lucide-react";
...
export function SettingsDialog({
  ...
  /** Open the rotate-key confirm dialog (invalidates current key, surfaces new recovery code). */
  onRotateKeyRequest: () => void;
  /** Open the self-delete account confirm dialog (destructive, two-factor). */
              ...
              <section className="space-y-3">
                ...
                <div className="space-y-4 rounded-lg border border-border bg-card/40 p-4">
                  ...
                  <button
                    ...
                    className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-md border border-border px-3 py-2.5 text-sm text-foreground transition-colors hover:bg-accent/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
                    data-testid="settings-rotate-key"
                  >
                  ...
                  <button
                    ...
                    className="flex min-h-[44px] w-full items-center justify-center gap-2 rounded-md border border-destructive/30 px-3 py-2.5 text-sm text-destructive transition-colors hover:bg-destructive/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
