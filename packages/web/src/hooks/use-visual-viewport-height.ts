...
// makes the composer hug the top of the keyboard; combined with the root
// chain's `overflow:hidden` the page can no longer be dragged out of view.
//
// `onShrink` (optional): invoked when the visible height has decreased since
